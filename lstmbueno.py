...
Original file is located at
    https://colab.research.google.com/drive/12fknGnuoAvwufl-8olEqyN5aQO-Mvuvf
"""
...
# Dataset personalizado estilo fastai
...
def objective(trial):
    ...
    if len(train_ds) < batch_size or len(valid_ds) < batch_size:
        # Dataset muy pequeño para el batch size, descartamos esta combinación
        return float('inf')
...
def objective(trial):
    try:
        ...
        # Validar que el tamaño del dataset sea suficiente para batch_size
        if len(train_ds) < batch_size or len(valid_ds) < batch_size:
